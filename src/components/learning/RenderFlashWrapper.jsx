...
export function RenderFlashWrapper({ label = 'Live component', children, className }) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'relative rounded-xl border border-line/10 bg-surface-950 p-4 transition-shadow',
        className,
      )}
    >
      <div className="mb-2 flex items-center justify-between">
        <span className="flex items-center gap-1.5 text-xs font-medium text-content-muted">
